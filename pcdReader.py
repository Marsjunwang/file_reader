...
def reader_2_writer(index):
    ...
    CalibExtractor(src_pth=calib_path,targ_dir=calib_targ_pth,filename='{}.txt'.format(filename))
    if DEBUG:
        cal_time = time.time()
...
if __name__ == "__main__":
    # 1.Read config
    config_path = 'E:\a_project_\file_reader-main\config\xj3_to_kitti_28000.yaml'
